      ...
      <header className="sticky top-0 z-30 flex h-[72px] items-center justify-between border-b border-stroke bg-white px-4 dark:border-dark-3 dark:bg-gray-dark md:px-6 2xl:px-10 shadow-1">
        ...
        <div className="flex items-center gap-3 md:gap-4">
          ...
          <div className="relative" ref={notificationsRef}>
            ...
            {notificationsOpen && (
              <div className="absolute right-0 mt-3 w-80 max-w-[calc(100vw-2rem)] rounded-2xl border border-stroke bg-white p-4 shadow-xl dark:border-dark-3 dark:bg-gray-dark z-50 animate-in fade-in zoom-in-95 duration-100">
          ...
          <div className="relative" ref={userMenuRef}>
            ...
            {userMenuOpen && (
              <div className="absolute right-0 mt-3 w-60 max-w-[calc(100vw-2rem)] rounded-2xl border border-stroke bg-white p-2 shadow-xl dark:border-dark-3 dark:bg-gray-dark z-50 animate-in fade-in zoom-in-95 duration-100">
                <div className="px-3 py-2.5 border-b border-stroke dark:border-dark-3">
                ...
                <div className="py-1.5 space-y-0.5">
                  <button
                    ...
                    className="flex w-full cursor-pointer items-center gap-2.5 rounded-xl px-3 py-2 text-xs font-medium text-dark hover:bg-gray-2 dark:text-white dark:hover:bg-dark-3 transition"
                  >
                  ...
                  <Link
                    ...
                    className="flex items-center gap-2.5 rounded-xl px-3 py-2 text-xs font-medium text-dark-5 hover:bg-gray-2 hover:text-dark dark:text-dark-6 dark:hover:bg-dark-3 dark:hover:text-white transition"
                  >
                    <Settings className="h-4 w-4" />
                    <span>Account Settings</span>
                  </Link>

                  <div className="border-t border-stroke my-1 dark:border-dark-3" />

                  <button
                    onClick={handleSignOut}
                    className="flex w-full cursor-pointer items-center gap-2.5 rounded-xl px-3 py-2 text-xs font-medium text-red-500 hover:bg-red-50 dark:hover:bg-dark-3 transition"
                  >
